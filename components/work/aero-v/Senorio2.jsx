...
//
// 尺寸與定位跟前一個 senorio 一模一樣，所以直接沿用 .av-senorio 這個 class。
// ⚠️ 兩張都依使用者 2026-08-28 的指定改成**對齊導覽列寬度**（.page-container
// 同寬，1440 時 1360），不是 Figma 的 1237 置中。詳見 Senorio.jsx 的說明。
//
// 素材 senorio2.jpg 是 2528×1696；1x 重出成 1360×913、@2x 用原生 2528×1696
// （= 1.86x，沒有假放大）。
