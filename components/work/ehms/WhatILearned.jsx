    ...
    <section className="eh-section eh-col" ref={ref} aria-labelledby="eh-learned-h">
      ...
      <div className="eh-body eh-body--lg eh-in">
        ...
        <ul className="eh-list">
          ...
          <li>
            I proposed a design system, which is standard practice elsewhere but new to this team
          </li>
        </ul>
        <p>
          Not everyone on the team thinks visually. A screen at eighty per cent is easier to react to
          than a description, and it gave people something to disagree with. None of this was
          invented. I read about design systems before I proposed one, and what I contributed was
